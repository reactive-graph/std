...
use inexor_rgf_model_http::BEHAVIOUR_HTTP;
use inexor_rgf_model_http::BEHAVIOUR_JSON_RPC;
use inexor_rgf_model_http::COMPONENT_BEHAVIOUR_HTTP;
use inexor_rgf_model_http::COMPONENT_BEHAVIOUR_JSON_RPC;
