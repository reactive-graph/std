...
use inexor_rgf_model_color as model_color;
use log::error;

use crate::di::profiles;
use crate::di::Container;
use crate::di::Provider;
use crate::plugin::ColorPlugin;
...
pub fn construct_plugin() -> Result<Arc<dyn Plugin>, PluginLoadingError> {
    ...
    let plugin = Provider::<dyn ColorPlugin>::create(container);
...
extern "C" fn get_dependencies() -> Vec<PluginDependency> {
    vec![PluginDependency::new("inexor-rgf-plugin-base", ">=0.9.0, <0.10.0")]
}
