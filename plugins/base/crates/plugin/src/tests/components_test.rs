...
use reactive_graph_model_base::DescribableProperties::DESCRIPTION;
use reactive_graph_model_base::Licensed;
use reactive_graph_model_base::LicensedProperties::ATTRIBUTION;
use reactive_graph_model_base::LicensedProperties::LICENSE;
use reactive_graph_model_base::Named;
use reactive_graph_model_base::NamedProperties::NAME;
use reactive_graph_model_base::SPDXLicensed;
use reactive_graph_model_base::SemVer;
use reactive_graph_model_base::Versioned;
use reactive_graph_model_base::VersionedProperties::VERSION;
use reactive_graph_model_base::COMPONENT_DESCRIBABLE;
use reactive_graph_model_base::COMPONENT_LICENSED;
use reactive_graph_model_base::COMPONENT_NAMED;
use reactive_graph_model_base::COMPONENT_VERSIONED;
use reactive_graph_model_base::NAMESPACE_BASE;
