...
use reactive_graph_model_logical::LogicalOperation;
use reactive_graph_model_logical::LogicalOperationProperties;
use reactive_graph_model_logical::COMPONENT_LOGICAL_OPERATION;
