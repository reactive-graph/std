...
//     std::sync::RwLock<std::collections::HashMap<Uuid, std::sync::Arc<ArithmeticOperation<'static>>>>,
// );
...
impl ArithmeticEntityBehaviourProvider for ArithmeticEntityBehaviourProviderImpl {
    // fn create_arithmetic_operation(&self, entity_instance: Arc<ReactiveEntityInstance>) {
    ...
    // fn remove_arithmetic_operation(&self, entity_instance: Arc<ReactiveEntityInstance>) {
    //     self.arithmetic_operations
    //         .0
    //         .write()
    //         .unwrap()
