...
// pub const FN_MAX_F64: ArithmeticGateFunction<f64> = |lhs, rhs| std::cmp::max(lhs, rhs);
// pub const FN_MIN_F64: ArithmeticGateFunction<f64> = |lhs, rhs| std::cmp::min(lhs, rhs);
