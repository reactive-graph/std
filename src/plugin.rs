...
use crate::behaviour::entity::entity_behaviour_provider::ConfigEntityBehaviourProviderImpl;
...
use crate::provider::{ConfigEntityTypeProviderImpl, ConfigFlowProviderImpl};
...
pub struct ConfigPluginImpl {
    ...
    entity_behaviour_provider: Wrc<ConfigEntityBehaviourProviderImpl>,
